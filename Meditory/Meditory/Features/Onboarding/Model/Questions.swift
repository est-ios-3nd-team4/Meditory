...
struct QuestionModel: Hashable {
  ...
  static let concernModel: [QuestionModel] = [
    .init(code: "concern_1", title: "간 건강", type: .concern, image: "icon_lung"),
    .init(code: "concern_2", title: "노화 건강", type: .concern, image: "icon_aging"),
    .init(code: "concern_3", title: "뼈 건강", type: .concern, image: "icon_bone"),
    .init(code: "concern_4", title: "뇌 건강", type: .concern, image: "icon_brain"),
    .init(code: "concern_5", title: "눈 건강", type: .concern, image: "icon_eye"),
    .init(code: "concern_6", title: "면역 건강", type: .concern, image: "icon_immune"),
    .init(code: "concern_7", title: "피로 건강", type: .concern, image: "icon_tiredness"),
    .init(code: "concern_8", title: "폐 건강", type: .concern, image: "icon_lung"),
    .init(code: "concern_9", title: "근육 건강", type: .concern, image: "icon_muscle"),
    .init(code: "concern_10", title: "수면 건강", type: .concern, image: "icon_sleep"),
    .init(code: "concern_11", title: "체중 건강", type: .concern, image: "icon_weight"),
    .init(code: "concern_12", title: "여성 건강", type: .concern, image: "icon_feminine"),
  ]
  ...
  static let feminineModel: [QuestionModel] = [
    .init(
      ...
      toggleImage: .name(base: "pregnancy")
    ),
    .init(
      code: "femal_extra_2",
      title: "수유 중",
      ...
      toggleImage: .name(base: "breastfeeding")
    ),
  ]
}
